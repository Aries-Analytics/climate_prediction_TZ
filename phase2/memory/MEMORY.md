...
- **Pipeline status (March 2026):** Shadow run ACTIVE Mar 7 – Jun 12, 2026 (revised — 7 missed days). 12 forecasts/run (3 triggers × 4 horizons × Morogoro). **216/1,080 forecasts (20.0%), 18 valid run-days (Mar 11, 15–31). Current streak: 17 consecutive (Mar 15–31).** Evidence Pack accumulates; Brier Score auto-evaluation starts ~Jun 9. Completion auto-detected at day 90 — final report + Slack alert fire automatically.
