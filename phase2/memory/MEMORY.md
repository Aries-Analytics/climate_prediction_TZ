...
| 2026-03-30 | Basis risk proxy strategy designed; Kilombero cooperative call list compiled (MVIWATA, RCT, RUDI, KATRIN contacts + IUCN warm door); NDVI proxy validation built + deployed — ndvi_observations table, GEE monthly composite, orchestrator Stage 3 hook, 17-day backfill complete; Mar 2026 anomaly -0.031 (monitoring zone); Alembic stamp fix documented |
