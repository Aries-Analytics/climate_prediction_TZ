...
- **Pipeline status (March 2026):** Shadow run ACTIVE Mar 7 – Jun 12, 2026 (revised — 7 missed days). 12 forecasts/run (3 triggers × 4 horizons × Morogoro). **204/1,080 forecasts (18.9%), 17 valid run-days (Mar 11, 15–30). Current streak: 16 consecutive (Mar 15–30).** Evidence Pack accumulates; Brier Score auto-evaluation starts ~Jun 9.
...
*Last updated: 2026-03-30 (pipeline run)*
