...
def main():
    ...
    for model_name in ["random_forest", "xgboost", "lstm", "ensemble"]:
        ...
        if model_name == "ensemble":
            y_pred_test = create_ensemble((rf_model, xgb_model, lstm_model), X_test, lookback)
        ...
        evaluation_results[model_name] = {"metrics": metrics, "predictions": y_pred_test}
    ...
    summary = {
        ...
        "models": {
            name: {"metrics": results["metrics"], "training_time": models_results.get(name, {}).get("training_time", 0)}
