...
def main():
    ...
    if 'combined_impact_score' in processed_data.columns:
        ...
        print(f"   Range: {processed_data['combined_impact_score'].min():.2f} to {processed_data['combined_impact_score'].max():.2f}")
        print()
    ...
    key_cols = ['year', 'month', 'oni', 'iod', 'enso_strength', 'iod_strength',
                'combined_impact_score', 'drought_risk_score', 'flood_risk_score']
