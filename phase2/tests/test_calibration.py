...
from modules.calibration.config_loader import (
    load_trigger_config,
...
class TestRainfallDistributionAnalysis:
    ...
    def test_analyze_rainfall_distribution_has_required_keys(self, sample_rainfall_data):
        ...
        required_keys = [
            'daily_rainfall_p90', 'daily_rainfall_p95', 
            'daily_rainfall_p97', 'daily_rainfall_p99',
            'rainfall_7day_p95', 'rainfall_7day_p97', 'rainfall_7day_p99',
            'rainfall_30day_p90', 'rainfall_30day_p95', 'rainfall_30day_p97'
        ]
...
class TestEdgeCases:
    ...
    def test_handles_single_month_data(self):
        ...
        df = pd.DataFrame({
            ...
            'rainfall_7day': [10, 20, 30],
            'rainfall_30day': [10, 20, 30]
        })
