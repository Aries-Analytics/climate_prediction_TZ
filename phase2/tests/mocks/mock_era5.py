...
class MockERA5API(BaseMockAPI):
    ...
    def _generate_variable(self, variable: str, dates: pd.DatetimeIndex) -> np.ndarray:
        ...
        if "temperature" in variable:
            ...
            temp = MockDataGenerator.generate_seasonal_pattern(
                dates, base_value=24.5, amplitude=3.5, peaks=[1, 10]
            )
            ...
            wind = MockDataGenerator.generate_seasonal_pattern(
                dates, base_value=base, amplitude=1.5, peaks=[7, 8]
            )
            ...
            pressure = MockDataGenerator.generate_seasonal_pattern(
                dates, base_value=1013.0, amplitude=5.0, peaks=[7]
            )
