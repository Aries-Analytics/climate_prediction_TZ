...
def demo_chirps_processing():
    ...
    sample_cols = [
        'year', 'month', 'rainfall_mm', 'consecutive_dry_days',
        'spi_30day', 'drought_severity', 'flood_risk_score',
        'drought_trigger', 'flood_trigger'
    ]
...
if __name__ == "__main__":
    try:
        ...
        sample_cols = [
            'year', 'month', 'rainfall_mm', 'rainfall_30day',
