...
- **Admin**: `admin@climate-insurance.tz` / `AdminPass2025!`
- **Analyst**: `analyst@climate-insurance.tz` / `AnalystPass2025!`
- **Manager**: `manager@climate-insurance.tz` / `ManagerPass2025!`
...
|------|-------|-------------|
| Dashboard | http://localhost:3000 | See Login Credentials section above |
