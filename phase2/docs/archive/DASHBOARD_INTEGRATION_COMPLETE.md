...
**Scripts Created:**
1. `load_climate_data.py` - Loads 191 monthly climate records (2010-2025)
2. `load_trigger_events.py` - Extracts drought/flood/crop failure triggers (67 events)
3. `load_model_metrics.py` - Loads ML model performance metrics (4 models)
...
- [x] 191 climate records (2010-2025)
- [x] 67 trigger events loaded (25 drought, 27 flood, 15 crop failure)
- [x] 4 model metrics (RF, XGBoost, LSTM, Ensemble)
- [ ] 3 users created
