...
**Updated:** February 2, 2026 (Added soil moisture index)  
**Location:** Kilombero Basin, Morogoro Region, Tanzania  
**Purpose:** Single-location pilot to validate ensemble climate prediction model with dual-index triggers before multi-location rollout
