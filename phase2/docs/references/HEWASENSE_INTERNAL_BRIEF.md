...
**Document Type**: Strategic Business Analysis — Internal Reference
**Date**: April 2026
**Status**: Forward Validation Active — Week 4 of a 90-day validation run (live forecast count in Evidence Pack dashboard)
**Author**: HewaSense Climate Intelligence & Insurance Team
**Audience**: Internal · Technical Partners · Due Diligence
...
Our retrospective validation (2000–2025) showed the model catching **all confirmed major crop failure events** in that window — specifically the 2017/2018 and 2021/2022 disasters (zero false negatives on confirmed crop failures). The validation run tests if this holds on data the model has never seen.
