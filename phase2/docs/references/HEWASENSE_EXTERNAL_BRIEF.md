...
| Forecasts accumulated       | 228 (19 valid run-days, March 29, 2026)         | Live system — updated as shadow run progresses    | Live system — updated as shadow run progresses    | Live system — updated as shadow run progresses    | Live system — updated as shadow run progresses    |
