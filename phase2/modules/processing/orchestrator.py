...
def run_processing_pipeline(sources: Optional[List[str]] = None, 
                           skip_merge: bool = False) -> Dict:
    """
    ...
    # Final status
    pipeline_status = {
        'status': 'success' if failed == 0 and merge_status == 'success' else 'partial' if failed < len(results) else 'failed',
