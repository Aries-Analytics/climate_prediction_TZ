...
def _get_default_config() -> Dict:
    ...
    return {
        ...
        'flood_triggers': {
            ...
            'rainfall_percentile': {
                'threshold': 99,
                'rationale': 'Default extreme rainfall percentile'
            }
        },
        'drought_triggers': {
            'spi_30day': {
            ...
            'rainfall_deficit_pct': {
                'threshold': 50,
                'rationale': 'Default significant rainfall deficit'
            }
        },
        'crop_failure_triggers': {
            'vci_threshold': {
            ...
            'crop_failure_risk_score': {
                'threshold': 75,
                'rationale': 'Default high crop failure probability'
            }
        },
