"""
Check what columns are in each processed file.

This script inspects the structure of processed data files to verify
they have the required columns (year, month, location) for proper merging.
"""
import sys
...
print("Checking processed files in data/processed/\n")
print("=" * 80)
