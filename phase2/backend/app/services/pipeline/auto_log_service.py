...
LOGS_DIR        = REPO_ROOT / "memory" / "logs"
PARAMETRIC_DOC  = REPO_ROOT / "docs" / "references" / "PARAMETRIC_INSURANCE_FINAL.md"
EXTERNAL_BRIEF  = REPO_ROOT / "docs" / "references" / "HEWASENSE_EXTERNAL_BRIEF.md"
EXECUTIVE_SUM   = REPO_ROOT / "docs" / "current" / "EXECUTIVE_SUMMARY.md"
PIPELINE_STATUS = REPO_ROOT / "docs" / "current" / "PIPELINE_STATUS_MARCH2026.md"
BUSINESS_CASE   = REPO_ROOT / "docs" / "references" / "BUSINESS_CASE_AND_DEPLOYMENT_RATIONALE.md"
...
def _git_commit_and_push(run_date, total_forecasts, pct, valid_run_days) -> None:
    ...
    files_to_stage = [
        ...
        "docs/references/HEWASENSE_EXTERNAL_BRIEF.md",
        "docs/current/EXECUTIVE_SUMMARY.md",
        "docs/current/PIPELINE_STATUS_MARCH2026.md",
        "docs/references/BUSINESS_CASE_AND_DEPLOYMENT_RATIONALE.md",
    ]
    ...
    try:
        ...
        subprocess.run(
            ...
            cwd=repo, check=True, capture_output=True, text=True,
            env={**os.environ, "GIT_AUTHOR_NAME": "HewaSense Pipeline",
