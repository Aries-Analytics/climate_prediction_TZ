...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='Tanzania Climate Prediction - Data Pipeline'
    )
    parser.add_argument(
        '--debug',
        action='store_true',
        help='Enable debug logging and dry-run mode (uses mock data)'
    )
    parser.add_argument(
        '--start-year',
        type=int,
        default=2000,
        help='Start year for data ingestion (default: 2000)'
    )
    parser.add_argument(
        '--end-year',
        type=int,
        default=2023,
        help='End year for data ingestion (default: 2023)'
    )
